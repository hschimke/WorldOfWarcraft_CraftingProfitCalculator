...
const sql_check_item = 'SELECT COUNT(*) AS how_man FROM items WHERE item_id = ? AND region = ?';
const sql_check_realm = 'SELECT COUNT(*) AS how_man FROM realms WHERE connected_realm_id = ? AND region = ?';
